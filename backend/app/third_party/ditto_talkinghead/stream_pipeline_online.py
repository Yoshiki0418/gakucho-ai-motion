...
import numpy as np
from app.third_party.ditto_talkinghead.core.atomic_components.audio2motion import (
    Audio2Motion,
)
from app.third_party.ditto_talkinghead.core.atomic_components.avatar_registrar import (
    AvatarRegistrar,
    smooth_x_s_info_lst,
)
from app.third_party.ditto_talkinghead.core.atomic_components.cfg import (
    parse_cfg,
    print_cfg,
)
from app.third_party.ditto_talkinghead.core.atomic_components.condition_handler import (
    ConditionHandler,
    _mirror_index,
)
from app.third_party.ditto_talkinghead.core.atomic_components.decode_f3d import (
    DecodeF3D,
)
from app.third_party.ditto_talkinghead.core.atomic_components.motion_stitch import (
    MotionStitch,
)
from app.third_party.ditto_talkinghead.core.atomic_components.putback import PutBack
from app.third_party.ditto_talkinghead.core.atomic_components.warp_f3d import WarpF3D
from app.third_party.ditto_talkinghead.core.atomic_components.wav2feat import Wav2Feat
from app.third_party.ditto_talkinghead.core.atomic_components.writer import (
    VideoWriterByImageIO,
)
        ...
        while not self.stop_event.is_set():
            ...
            while True:
                ...
                aud_cond = self.condition_handler(
                    aud_feat, global_idx + self.cond_idx_start
                )[None]
                        ...
                        while not self.stop_event.is_set():
                            try:
                                self.motion_stitch_queue.put(
                                    [frame_idx, x_d_info, ctrl_kwargs], timeout=1
                                )
                                break
                            except queue.Full:
                                continue
